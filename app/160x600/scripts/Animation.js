...
app.Animation = (function () {
	...
	// --------------------------------------------------------------------------------------
	function start() {
        tl1.from(bag1, 1, {x:100, ease: Cubic.easeOut})
            .from(bag2, 1, {x:-100, ease: Cubic.easeOut},"-=.75")
            .from(bag3, 1, {x:100, ease: Cubic.easeOut},"-=.8")
            .from(txt1, 1, {y: -84, ease: Cubic.easeInOut})
	}
